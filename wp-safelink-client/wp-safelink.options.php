				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							...
							<td>
								<input <?php if ($wpsaf_client->adlinkfly_enable == 1) echo 'checked'; ?> type="radio" name="wpsaf_client[adlinkfly_enable]" value="1" id="adlinkfly_enable1"><label for="adlinkfly_enable1">Yes</label>
								<input <?php if (empty($wpsaf_client->adlinkfly_enable) || $wpsaf_client->adlinkfly_enable == 2) echo 'checked'; ?> type="radio" name="wpsaf_client[adlinkfly_enable]" value="2" id="adlinkfly_enable0"><label for="activerecaptcha0">No</label>
							</td>
						</tr>
						<tr>
							<td><b>Your Adlinkfly Domain</b></td>
							<td><input value="<?php echo $wpsaf_client->adlinkfly_domain; ?>" type="text" placeholder="https://go.themeson.com/" size="40" name="wpsaf_client[adlinkfly_domain]" />
						</tr>
						<tr>
