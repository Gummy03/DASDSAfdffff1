...
<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            <a href="" class="navbar-brand"><img alt="wpsafelink image" src="<?php echo $_GET['logo'] ?>"
                                                 class="img-logo"/></a>
                ...
                <div class='panel panel-default'>
                    <div class='panel-body'>
                        <div class="wpsafe-top text-center">
                            <div><?php echo wp_kses_stripslashes($_GET['ads1']); ?></div>
                        ...
                        <div class="wpsafe-bottom text-center" id="wpsafegenerate">
                            ...
                            <div id="wpsafe-link"><a href="<?php echo $_GET['linkr']; ?>" target="_self"
                                                     rel="nofollow">
                                <?php if($wpsaf->action_type == 'button') : ?>
                            ...
                            <div><?php echo wp_kses_stripslashes($_GET['ads2']); ?></div>
                        </div>
                    </div>
